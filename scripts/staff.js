...
var data_product = [
    {'Product Name': 'Product 1', 'Description': 'Description 1', 'Price': 'Price 1', 'Stock': 'Stock 1','image_link':'image_link 1','edit': '<button class="edit">edit</button>'},
...
var data_order = [
    {'Order ID': 'Order 1', 'Client ID': 'Client 1', 'Product ID': 'Product 1', 'Quantity': 'Quantity 1', 'Price': 'Price 1', 'Total price': 'Total price 1','delete': '<button class="delete">delete</button>'},
    {'Order ID': 'Order 2', 'Client ID': 'Client 2', 'Product ID': 'Product 2', 'Quantity': 'Quantity 2', 'Price': 'Price 2', 'Total price': 'Total price 2','delete': '<button class="delete">delete</button>'},
    {'Order ID': 'Order 3', 'Client ID': 'Client 3', 'Product ID': 'Product 3', 'Quantity': 'Quantity 3', 'Price': 'Price 3', 'Total price': 'Total price 3','delete': '<button class="delete">delete</button>'},
    {'Order ID': 'Order 4', 'Client ID': 'Client 4', 'Product ID': 'Product 4', 'Quantity': 'Quantity 4', 'Price': 'Price 4', 'Total price': 'Total price 4','delete': '<button class="delete">delete</button>'},
    {'Order ID': 'Order 5', 'Client ID': 'Client 5', 'Product ID': 'Product 5', 'Quantity': 'Quantity 5', 'Price': 'Price 5', 'Total price': 'Total price 5','delete': '<button class="delete">delete</button>'}
];
